...
// set dob min and max and slider display on load
window.onload = function() {
    ...
    // slider live value display - from professor example
...
// loop based on professor getdata1() example
function reviewData() {
    ...
    // grab fields we need to validate individually
    ...
    // build the popup html - based on professor output table style
